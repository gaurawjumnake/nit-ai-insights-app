...
class Project(Base):
    ...
    # Align with accounts.id which is UUID in database
    ...
    ai_revenue = Column(Float, default=0.0)  # AI Direct Revenue
    ai_assisted_revenue = Column(Float, default=0.0)  # AI Indirect/Assisted Revenue
    ...
    # Store as JSONB to match existing database column type
